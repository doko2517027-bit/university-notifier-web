...
document.head.insertAdjacentHTML("beforeend",`<style>
  .clinical-toolbar{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin:10px 0}.clinical-editor{display:grid;gap:12px}.clinical-editor h3{margin:0}.clinical-form-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.clinical-form-grid.two{grid-template-columns:repeat(2,minmax(0,1fr))}.clinical-editor label{display:grid;gap:6px;font-weight:700}.clinical-editor input,.clinical-editor textarea,.clinical-editor select{box-sizing:border-box;width:100%;font:inherit;padding:10px;border:1px solid var(--border);border-radius:10px;background:var(--card);color:inherit}.clinical-editor textarea{resize:vertical;min-height:96px}.clinical-role-chip{padding:5px 10px;border-radius:999px;background:#e0f2fe;color:#075985;font-weight:700;font-size:.85rem}.clinical-record-type{border:1px solid var(--border);border-radius:14px;padding:14px;background:color-mix(in srgb,#0f766e 4%,var(--card))}.clinical-chart-values{display:flex;justify-content:space-between;gap:8px;margin-top:8px;color:var(--subtext);font-size:.85rem}@media(max-width:780px){.clinical-form-grid,.clinical-form-grid.two{grid-template-columns:1fr}.clinical-toolbar{align-items:stretch}.clinical-toolbar .btn,.clinical-toolbar select{width:100%}}
</style>`);
